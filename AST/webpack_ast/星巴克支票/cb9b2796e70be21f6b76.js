    ...
    JFyB: function(e, t, n) {
        ...
        function A(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "XwKsGlMcdPMEhR1B"
              , n = h.a.enc.Utf8.parse(t)
              , A = h.a.enc.Utf8.parse(e);
            return h.a.AES.encrypt(A, n, {
                mode: h.a.mode.ECB,
            ...
            function t(e) {
                for (var A = "100|1000".split("|"), i = 0; []; ) {
                    ...
                    case "1":
                        ...
                        continue;
                    case "2":
                        var o = n.MuiZC(parseInt, n.qsNlB((new Date).getTime(), "").slice(10, 12));
                        continue;
                    case "3":
                        var r = "\t";
                        continue;
                    case "4":
                        ...
                        continue;
                    case "5":
                        if (n.HYROO(void 0 === e ? "undefined" : u()(e), n.AVzMu))
                            return function(e) {}
                            .constructor(n.QusDC).apply("counter");
                        1 !== ("" + n.wqPYy(e, e)).length || e % 20 == 0 ? function() {
                            return !![]
                        }
                        .constructor(n.qsNlB(n.UiGsf + "gger", r)).call("action") : function() {
                            return ![]
                        }
                        .constructor(n.qsNlB(n.qsNlB(n.UiGsf, "gger"), r)).apply("stateObject");
                        continue
                    }
                    break
                }
        ...
        function o(e) {
            var t, n, A, i, o = e.$el.parentNode.offsetWidth || window.offsetWidth, r = e.$el.parentNode.offsetHeight || window.offsetHeight;
            return t = -1 != e.imgSize.width.indexOf("%") ? parseInt(this.imgSize.width) / 100 * o + "px" : this.imgSize.width,
            n = -1 != e.imgSize.height.indexOf("%") ? parseInt(this.imgSize.height) / 100 * r + "px" : this.imgSize.height,
            A = -1 != e.barSize.width.indexOf("%") ? parseInt(this.barSize.width) / 100 * o + "px" : this.barSize.width,
        ...
        !function() {
            ...
            b(this, function() {
                var t = new RegExp("function *\\( *\\)")
                  , n = new RegExp(e.QFzkU,"i")
                  , A = e.TunXh(i, e.eHaVF);
                t.test(A + e.khbbb) && n.test(e.WJNLG(A, "input")) ? i() : e.NQojX(A, "0")
            })()
        }();
        var v = function() {
            var e = !![];
        ...
        v(this, function() {
            for (var e = {
                ...
                var t;
                try {
                    t = Function(e.dLtIS("return (function() ", '{}.constructor("return this")( )') + ");")()
                } catch (e) {
                    t = "undefined" != typeof window ? window : this
                }
                return t
            }, n = e.Zeony(t), A = n ? n.console = n.console || {} : e.XrgKn("undefined" == typeof console ? "undefined" : u()(console), e.HuDZM) ? console : void 0, i = A ? ["log", e.sHtQL, e.VyjTA, e.XbLix, "exception", "table", "trace"] : [], o = 0; e.Kgdqy(o, i.length); o++) {
                var r = v.constructor.prototype.bind(v)
                  , a = i[o]
                  , s = A && A[a] || r;
                r.__proto__ = v.bind(v),
                r.toString = s.toString.bind(s),
                A[a] = r
            }
        })();
        var m = n("H5QF")
        ...
        Object,
        {
            ...
            methods: {
                ...
                move: function(e) {
                    ...
                    this.status && 0 == this.isEnd) {
                        ...
                        var n = this.barArea.getBoundingClientRect().left
                          , A = t - n;
                        A >= this.barArea.offsetWidth - parseInt(parseInt(this.blockSize.width) / 2) - 2 && (A = this.barArea.offsetWidth - parseInt(parseInt(this.blockSize.width) / 2) - 2),
                    ...
                    if (this.status && 0 == this.isEnd) {
                        var t = parseInt((this.moveBlockLeft || "").replace("px", ""));
                        t = 310 * t / parseInt(this.setSize.imgWidth);
                        var n = {
                            captchaType: this.captchaType,
                            pointJson: this.secretKey ? A(f()({
                                x: t,
                                y: 5
                            }), this.secretKey) : f()({
                                x: t,
                        ...
                        Object(m.b)("/efapiao/c/captcha/slider/check", n, 0).then(function(n) {
                            if ("0000" == n.repCode) {
                                ...
                                e.passFlag = !0,
                                e.tipWords = ((e.endMovetime - e.startMoveTime) / 1e3).toFixed(2) + "s " + e.successMsg;
                                var i = e.secretKey ? A(e.backToken + "---" + f()({
                                    x: t,
                                    y: 5
                                }), e.secretKey) : e.backToken + "---" + f()({
                                    x: t,
                                    y: 5
                                });
                                setTimeout(function() {
                ...
                getPictrue: function() {
                    ...
                    Object(m.b)("/efapiao/c/captcha/slider/get", t, 0).then(function(t) {
          ...
          , I = function() {
            ...
            }, [e._v(e._s(e.tipWords))]) : e._e()])], 1)]) : e._e(), e._v(" "), n("div", {
        ...
        var y = {
          ...
          , w = y
          , z = n("VU/8")
          , Y = z(x, w, !1, null, null, null);
        Y.options.__file = "src/components/verifition/Verify/VerifySlide.vue";
        var B = Y.exports
          , M = (String,
        Number,
        Number,
        ...
        Object,
        {
            ...
            methods: {
                uuid: function() {
                    ...
                    localStorage.getItem("point") || localStorage.setItem("point", i)
                },
                i18n: function(e) {
                    return this.$t ? this.$t(e) : (this.$options.i18n.messages[this.locale] || this.$options.i18n.messages["en-US"])[e]
                },
                refresh: function() {
          ...
          , S = function() {
            ...
            }, [e.componentType ? n(e.componentType, {
                ref: "instance",
                tag: "components",
                attrs: {
        ...
        var j = {
          ...
          , C = n("VU/8")
          , T = r
          , k = C(M, R, !1, T, null, null);
        k.options.__file = "src/components/verifition/Verify.vue";
        var P = k.exports
          , V = (s.a,
        {
            name: "ExtractionCode",
            ...
            data: function() {
                return {
                    extractionCode: null,
                    encryptExtractionCode: null,
                    orderType: null,
                    channelType: null,
                    thirdUserId: null,
                    confirmCode: "",
                    isWechatMiniProgram: !1
                }
            },
            methods: {
                handleParams: function() {
                    var e = {};
                    return e.extractionCode = this.extractionCode,
                    e.encryptExtractionCode = this.encryptExtractionCode,
                    e.orderType = this.orderType,
                    e.channelType = this.channelType,
                    e
                },
                queryTransactionButton: function() {
                    var e = this;
                    if (!e.extractionCode)
                        return void e.eAlert(e.$t("extractionCode.input.empty"));
                    this.$refs.verify.show()
                },
                verifySuccess: function(e) {
                    var t = this;
                    t.eLoadingOpen();
                    var n = t.handleParams();
                    n.token = e.captchaVerification,
                    t.$$api_transaction_query({
                        data: n,
                        fn: function(e) {
                            "000" == e.returnCode && e.data ? (n = e.data,
                            t.createInvoiceOrder(n)) : (t.eLoadingClose(),
                            t.errorCode = e.returnCode,
                            a.a.errorCode.systemMaintenance != t.errorCode && t.eAlert(e.msg))
                        },
                        errFn: function(e) {
                            t.eLoadingClose(),
                            t.errorCode = e.returnCode,
                ...
                queryTransaction: function() {
                    var e = this;
                    e.eLoadingOpen();
                    var t = e.handleParams();
                    e.$$api_transaction_queryExternal({
                        data: t,
                        fn: function(n) {
                            "000" == n.returnCode && n.data ? (t = n.data,
                            e.createInvoiceOrder(t)) : (e.eLoadingClose(),
                            e.errorCode = n.returnCode,
                            a.a.errorCode.systemMaintenance != e.errorCode && e.eAlert(n.msg))
                        },
                        errFn: function(t) {
                            e.eLoadingClose(),
                            e.errorCode = t.returnCode,
                            e.eAlert(t.msg)
                        }
                    })
                },
                checkTransaction: function() {
                    ...
                    e.interval = setInterval(function() {
                        e.intervalNum++,
                        e.$$api_transaction_check({
                            data: t,
                            fn: function(n) {
                                "000" === n.returnCode ? n.data && (clearInterval(e.interval),
                                t = n.data,
                                e.createInvoiceOrder(t)) : (clearInterval(e.interval),
                                e.eLoadingClose(),
                                e.eAlert(n.msg))
                            },
                            errFn: function(t) {
                ...
                createInvoiceOrder: function(e) {
                    var t = this
                      , n = {};
                    n.transactions = [e],
                    n.thirdUserId = t.thirdUserId,
                    t.$device.isAlipay && (n.thirdType = "E00802"),
                    t.$device.isWechat && (n.thirdType = "E00801"),
                    t.$$api_invoiceOrder_create({
                        data: n,
                        fn: function(e) {
                            if ("000" === e.returnCode) {
                                n = e.data;
                                var A = e.rc;
                                if (n.orderStatus === a.a.orderStatus.orderProcessed)
                                    t.toInvoiceOrderSuccess(n.orderId);
                                else if (n.orderStatus === a.a.orderStatus.orderDownloading)
                                    t.toInvoiceOrderConfirm(n.orderId);
                                else if (n.orderStatus === a.a.orderStatus.orderError)
                                    t.toInvoiceOrderError(n.orderId);
                                else if (n.orderStatus === a.a.orderStatus.orderProcessing)
                                    t.toInvoiceOrderConfirm(n.orderId);
                                else if (n.orderStatus === a.a.orderStatus.invoiceManualProcessing)
                                    t.eLoadingClose(),
                                    t.eAlert("交易在开票中，如需发票请联系客服！");
                                else {
                                    var i = "dA==" === t.channelType || !t.orderType && !t.isWechatMiniProgram;
                                    A && "Y" == A.isMerge && i ? t.toInvoiceOrder(n.orderId) : t.toInvoiceOrderConfirm(n.orderId)
                                }
                            } else
                                t.eLoadingClose(),
                                t.eAlert(e.msg)
                ...
                init: function() {
                    var e = this.$route.query.order;
                    if (e) {
                        this.encryptExtractionCode = e.replace(/\s|\s/g, "+");
                        var t = this.$route.query.ordertype;
                        t && (this.orderType = t.replace(/\s|\s/g, "+"));
                        var n = this.$route.query.channeltype;
                        n && (this.channelType = n.replace(/\s|\s/g, "+")),
                        this.queryTransaction()
                    } else
                        this.systemMaintain()
                },
                handleMiniProgramBack: function(e) {
                    var t = this;
                    window.removeEventListener("popstate", this.handleMiniProgramBack),
                    t.isWechatMiniProgram && (WeixinJSBridge.call("closeWindow"),
                    c.a.miniProgram.navigateBack())
                }
            },
            mounted: function() {
                var e = this;
                if ("alipay" == navigator.userAgent.toLowerCase().match(/Alipay/i)) {
                    var t = this.$route.query.auth_code;
                    if (t)
                        e.thirdUserId ? e.init() : (e.eLoadingOpen(),
                        e.$$api_alipay_exchangeUserId({
                            data: {
                                authCode: t
                            },
                            fn: function(t) {
                                e.eLoadingClose(),
                                "000" === t.returnCode ? t.data && (e.thirdUserId = t.data) : "999" === t.returnCode && e.eAlert(t.msg),
                                e.init()
                            },
                            errFn: function(t) {
                                e.eLoadingClose(),
                        ...
                        window.location.href = "https://openauth.alipay.com/oauth2/publicAppAuthorize.htm?app_id=2017122701267547&scope=auth_invoice_info&redirect_uri=" + n
                    }
                } else
                    e.init()
            },
            created: function() {
                var e = this;
                e.$store.dispatch("setRoastery", e.$route.meta.isRoastery);
                var t = this.$route.query.channeltype;
                t && e.$store.dispatch("setChannelType", t.replace(/\s|\s/g, "+")),
                e.$device.isWechat && c.a.miniProgram.getEnv(function(t) {
                    t.miniprogram && (e.isWechatMiniProgram = !0,
                    history.length && 1 === history.length && window.addEventListener("popstate", e.handleMiniProgramBack))
                })
            },
            watch: {
                intervalNum: function(e, t) {
                    e >= 5 && (this.eLoadingClose(),
                    this.eAlert(this.$t("transaction.empty")),
          ...
          , X = function() {
            ...
            return n("flexbox", {
            ...
            }, [n("flexbox-item", [n("group", [n("x-input", {
                attrs: {
                    placeholder: e.$t("extractionCode.input"),
                    required: "",
                    novalidate: ""
                },
                on: {
                ...
                nativeOn: {
                    keyup: function(t) {
                        return !t.type.indexOf("key") && e._k(t.keyCode, "enter", 13, t.key, "Enter") ? null : e.queryTransactionButton.apply(null, arguments)
                    }
                },
                model: {
                    value: e.extractionCode,
                    callback: function(t) {
                        e.extractionCode = t
                    },
                    expression: "extractionCode"
                }
            })], 1)], 1), e._v(" "), n("flexbox-item", {
                staticStyle: {
                    "margin-top": "20px"
                }
            }, [n("x-button", {
                class: {
                    "roastery-button": e.isRoastery
                },
                nativeOn: {
                    click: function(t) {
                        return e.queryTransactionButton.apply(null, arguments)
                    }
                }
            }, [e._v(e._s(e.$t("efapiao.apply.submit")))])], 1), e._v(" "), n("Verify", {
                ref: "verify",
                attrs: {
                    title: e.$t("verify.title"),
                    successMsg: e.$t("verify.success"),
                    failMsg: e.$t("verify.fail"),
                    explain: e.$t("verify.explain"),
                    imgSize: {
                        width: "310px",
                        height: "155px"
                    }
        ...
        var L = {
          ...
          , D = L
          , H = n("VU/8")
          , F = H(V, D, !1, null, null, null);
        F.options.__file = "src/pages/ExtractionCode.vue",
        t.default = F.exports
    },
    tUYA: function(e, t, n) {
